...
namespace RestaurantManager.Engine.Factories
{
    ...
    public class RecipeFactory : IRecipeFactory
    {
        ...
        {
           return new Drink(name, price, calories, quantityPerServing, MetricUnit.Grams, timeToPrepare, isCarbonated);
        }
        ...
        {
            return new Salad(name, price, calories, quantityPerServing, MetricUnit.Grams, timeToPrepare, containsPasta);
        }
        ...
        {
            return  new MainCourse(name, price, calories, quantityPerServing, MetricUnit.Grams, timeToPrepare, MainCourseType.Entree);
        }
        ...
        {
            return new Dessert(name,price,calories,quantityPerServing, MetricUnit.Grams, timeToPrepare, isVegan);
        }
    }
}
