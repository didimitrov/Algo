...
namespace _01.StudentProject
{
    public class Student : ICloneable, IComparable<Student>
    {
        ...
        public Student(string firstName, string middleName, string lastName, int course, string ssn, string address,
            string phoneNumber, string emailAddress, SpecialtyType specialty, UniversityType university,
            FacultyType faculty)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            bool areEqual = student != null && this.FirstName == student.FirstName &&
        ...
        {
            return new Student(this.FirstName, this.MiddleName, this.LastName, this.Course, this.SSN, this.Address,
                this.PhoneNumber, this.EmailAddress, this.Specialty, this.University, this.Faculty);
        }
